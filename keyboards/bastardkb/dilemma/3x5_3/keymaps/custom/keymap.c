...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LAYER_BASE] = LAYOUT_split_3x5_3(
       ...
       PT_Z,    RALT_T(KC_X),    KC_C,    KC_V,    KC_B,    KC_N,    KC_M, KC_COMM,  RALT_T(KC_DOT), PT_SLSH,
                      TAB_MED, SPC_NUM, ESC_SYM, HYP_T(KC_BSPC), ENT_NAV, KC_MUTE
  ),
 ...
 */
  [LAYER_NAVIGATION] = LAYOUT_split_3x5_3(
    XXXXXXX, XXXXXXX, KC_PGDN, KC_PGUP, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
    XXXXXXX, XXXXXXX, KC_HOME, KC_END, XXXXXXX, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, XXXXXXX,
 ...
 */
  [LAYER_NUMERAL] = LAYOUT_split_3x5_3(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_PSLS, KC_4, KC_5, KC_6, KC_MINS,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_PAST, KC_1, KC_2, KC_3, KC_PLUS,
                      XXXXXXX, XXXXXXX, XXXXXXX, KC_DOT, KC_EQUAL, KC_0
  ),
 ...
 */
  [LAYER_SYMBOLS] = LAYOUT_split_3x5_3(
    ...
    LCTL_T(KC_GRV), LALT_T(KC_NO), LGUI_T(KC_NO), LSFT_T(KC_NO), KC_NO, KC_NO, LSFT_T(KC_J), LGUI_T(KC_K), LALT_T(KC_L), LCTL_T(KC_QUOT),
    KC_ESC, KC_CAPS, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_MINS, KC_EQL, XXXXXXX, XXXXXXX,
                      XXXXXXX,  KC_TAB, KC_SPC, KC_BSPC, KC_ENT, XXXXXXX
  ),
};
// clang-format on
